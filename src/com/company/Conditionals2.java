...
//        System.out.println("Find Best fit 3 6 4 is " + findBestFit(3,6,4));
        ...
        System.out.println("Make bench 3 1 8 is " + makeBench(3,1,8));      // T g
        System.out.println("Make bench 3 1 9 is " + makeBench(3,1,9));      // F g
        System.out.println("Make bench 11 1 15 is " + makeBench(11,1,15));  // T g
        System.out.println("Make bench 4 2 15 is " + makeBench(4,2,15));    // F g
        System.out.println("Make bench 20 0 20 is " + makeBench(20,0,20));  // T g
        System.out.println("Make bench 3 4 20 is " + makeBench(3,4,20));    // T g
        System.out.println("Make bench 0 6 30 is " + makeBench(0,6,30));    // T g
        System.out.println("Make bench 0 5 30 is " + makeBench(0,5,30));    // F g
        System.out.println("Make bench 2 6 23 is " + makeBench(2,6,23));    // F
    }
}